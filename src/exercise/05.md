...
Understood the useRef hook somewhat better and got clarity on why `ref.current`
is not available before rendering. Also got to know about it's use in tandem to
the useEffect hook.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=05%3A%20useRef%20and%20useEffect%3A%20DOM%20interaction&em=mail%40asheerrizvi.com).
