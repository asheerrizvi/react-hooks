...
Understood the useEffect hook and the order in which this hook is executed. This
exercise helped me develop a better mental modal for the dependency array and
highlighted the differences between useEffect's usage with no dependency array,
an empty dependency array and a dependency array having some entries. I also
learned about lazy state initialization which I wasn't aware of. And last but
not the least, I got to learn custom hooks and how much you can customize them
and abstract away complex logic while making them.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=mail%40asheerrizvi.com).
